    ...
    try {
      const updatedAppointment = await databases.updateDocument(
        ...
        ${type === 'schedule' ? `Your appointment has been scheduled for 
            ...
            `We regret to inform you that your appointment with Dr. ${appointment.primaryPhysician} has been cancelled for
            the following reason: ${appointment.cancellationReason}.`
        }`
